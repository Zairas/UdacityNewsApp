 ...
 */
public class OpinionFragment extends Fragment implements LoaderManager.LoaderCallbacks<List<Article>> {

    private static final String LOG_TAG = OpinionFragment.class.getName();
...
//        items.add(new Article("Id", "Name", "Publication Date", "Web Title", "Url", Article.TYPE_CELL));
    ...
    public Loader<List<Article>> onCreateLoader(int id, @Nullable Bundle args) {
        ...
        uriBuilder.appendQueryParameter("q", "opinion");
